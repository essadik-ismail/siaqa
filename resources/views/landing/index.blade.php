    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative">
                ...
                <!-- Floating Cards -->
                <div class="absolute -top-4 -left-4 bg-white rounded-2xl shadow-lg p-4 w-32">
                    <div class="text-xs text-gray-500 mb-1">Active Students</div>
                    <div class="text-2xl font-bold text-green-600">156</div>
                </div>
                
                <div class="absolute -bottom-4 -right-4 bg-white rounded-2xl shadow-lg p-4 w-32">
                    <div class="text-xs text-gray-500 mb-1">Lessons Today</div>
