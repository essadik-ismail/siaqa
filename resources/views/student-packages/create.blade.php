...
@section('title', 'Create Student Package')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Student Package</h3>
                </div>
                <div class="card-body">
                    <form id="studentPackageForm" method="POST" action="{{ route('student-packages.store') }}">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Create Student Package
                            </button>
                        </div>
                    </form>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('studentPackageForm').addEventListener('submit', function(e) {
        ...
        .catch(error => {
            ...
            alert('An error occurred while creating the student package.');
        });
    });
});
</script>
