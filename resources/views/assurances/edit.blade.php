        ...
        <form method="POST" action="{{ route('assurances.update', $assurance) }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="compagnie" id="compagnie" value="{{ old('compagnie', $assurance->compagnie) }}" required
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="type_assurance" id="type_assurance" required class="form-input w-full px-4 py-3">
                        ...
                        <option value="responsabilite_civile" {{ old('type_assurance', $assurance->type_assurance) == 'responsabilite_civile' ? 'selected' : '' }}>Responsabilité civile</option>
                        <option value="tous_risques" {{ old('type_assurance', $assurance->type_assurance) == 'tous_risques' ? 'selected' : '' }}>Tous risques</option>
                        <option value="vol_incendie" {{ old('type_assurance', $assurance->type_assurance) == 'vol_incendie' ? 'selected' : '' }}>Vol et incendie</option>
                        <option value="assistance" {{ old('type_assurance', $assurance->type_assurance) == 'assistance' ? 'selected' : '' }}>Assistance</option>
                    </select>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="date" name="date_debut" id="date_debut" value="{{ old('date_debut', $assurance->date_debut) }}" required
                ...
                <div>
                    ...
                    <input type="date" name="date_expiration" id="date_expiration" value="{{ old('date_expiration', $assurance->date_expiration) }}" required
                           class="form-input w-full px-4 py-3">
                ...
                <div>
                    ...
                    <input type="number" name="cout_annuel" id="cout_annuel" value="{{ old('cout_annuel', $assurance->cout_annuel) }}" step="0.01" min="0"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="franchise" id="franchise" value="{{ old('franchise', $assurance->franchise) }}" step="0.01" min="0"
                           class="form-input w-full px-4 py-3" placeholder="0.00">
                    @error('franchise')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <select name="statut" id="statut" required class="form-input w-full px-4 py-3">
                        ...
                        <option value="active" {{ old('statut', $assurance->statut) == 'active' ? 'selected' : '' }}>Active</option>
                        <option value="expiree" {{ old('statut', $assurance->statut) == 'expiree' ? 'selected' : '' }}>Expirée</option>
                        <option value="resiliee" {{ old('statut', $assurance->statut) == 'resiliee' ? 'selected' : '' }}>Résiliée</option>
                        <option value="en_attente" {{ old('statut', $assurance->statut) == 'en_attente' ? 'selected' : '' }}>En attente</option>
                    </select>
                    @error('statut')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
            ...
            <div>
                ...
                <textarea name="notes" id="notes" rows="4" 
                          class="form-input w-full px-4 py-3" placeholder="Informations supplémentaires...">{{ old('notes', $assurance->notes) }}</textarea>
                @error('notes')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
