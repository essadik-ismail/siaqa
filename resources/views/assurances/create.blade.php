    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">Nouvelle Assurance</h2>
                    <p class="text-gray-600">Ajouter une nouvelle assurance pour un véhicule</p>
                </div>
                <a href="{{ route('assurances.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg font-medium">
        ...
        <form method="POST" action="{{ route('assurances.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4" 
                          ...
                          placeholder="Description de l'assurance...">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
