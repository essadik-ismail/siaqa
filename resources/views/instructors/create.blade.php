...
@section('title', 'Créer un Instructeur')
...
<div class="min-h-screen">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="glass-effect rounded-2xl p-8 mb-8">
            <h1 class="text-4xl font-bold gradient-text mb-4">Créer un Instructeur</h1>
            <p class="text-gray-600 text-lg">Inscrivez un nouvel instructeur dans votre auto-école</p>
        </div>
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center">
                                    <input type="checkbox" name="license_categories[]" value="A" 
                                        {{ in_array('A', old('license_categories', [])) ? 'checked' : '' }}
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="specialties" id="specialties" rows="4"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                            placeholder="Conduite défensive, Conduite économique, etc.">{{ old('specialties') }}</textarea>
                        @error('specialties')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="notes" id="notes" rows="4"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                            placeholder="Notes sur l'instructeur...">{{ old('notes') }}</textarea>
                        @error('notes')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
