...
<div class="min-h-screen">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="glass-effect rounded-2xl p-8 mb-8">
            <h1 class="text-4xl font-bold gradient-text mb-4">Créer un Étudiant</h1>
            <p class="text-gray-600 text-lg">Inscrivez un nouvel étudiant dans votre auto-école</p>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="required_theory_hours" id="required_theory_hours" min="0"
                                value="{{ old('required_theory_hours', 20) }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <div>
                            ...
                            <input type="number" name="required_practical_hours" id="required_practical_hours" min="0"
                                value="{{ old('required_practical_hours', 20) }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="notes" id="notes" rows="4"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                            placeholder="Notes sur l'étudiant...">{{ old('notes') }}</textarea>
                        @error('notes')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
