...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex items-center justify-between mb-8">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Role Users</h1>
                <p class="text-gray-600 mt-1">Users assigned to {{ $role->display_name }}</p>
            </div>
        </div>
    </div>
        ...
        <div class="flex items-start justify-between">
            <div class="flex-1">
                ...
                <div class="flex items-center space-x-4 text-sm text-gray-500">
                    ...
                    <span><i class="fas fa-users mr-1"></i>{{ $users->total() }} users</span>
                </div>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-lg">
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-gray-600 mb-6">No users are currently assigned to this role.</p>
