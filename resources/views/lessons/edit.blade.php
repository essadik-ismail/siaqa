...
<div class="min-h-screen">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="glass-effect rounded-2xl p-8 mb-8">
            <h1 class="text-4xl font-bold gradient-text mb-4">Modifier la Leçon</h1>
            <p class="text-gray-600 text-lg">Modifiez les informations de la leçon</p>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="lesson_type" id="lesson_type" required
                                ...
                                <option value="theory" {{ old('lesson_type', $lesson->lesson_type) == 'theory' ? 'selected' : '' }}>Théorique</option>
                                <option value="practical" {{ old('lesson_type', $lesson->lesson_type) == 'practical' ? 'selected' : '' }}>Pratique</option>
                                <option value="simulation" {{ old('lesson_type', $lesson->lesson_type) == 'simulation' ? 'selected' : '' }}>Simulation</option>
                            </select>
                            @error('lesson_type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                            placeholder="Décrivez les détails de la leçon...">{{ old('description', $lesson->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
